...
export default function QnaUpdate() {
    ...
    const getBoardResponse = (result: GetBoardResponseDto | ResponseDto | null) => {
        ...
        const message =
            ...
            result.code === 'NB' ? '존재 하지 않는 접수 번호 입니다.' :
    ...
    return (
        <div id="qna-write-wrapper">
            ...
            <div className='qna-write-contents-box'>
                <textarea ref={contentsRef} className='qna-write-contents-textarea' placeholder='내용을 입력해주세요. / 1000자' 
                    maxLength={1000} value={contents} onChange={onContentsChangeHandler} />
            </div>
        </div>
    );
