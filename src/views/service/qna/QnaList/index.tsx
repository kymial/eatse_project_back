...
export default function QnaList() {
    ...
    const onSearchKeydownHandler = (event: KeyboardEvent<HTMLInputElement>) => {
            ...
            <div className='qna-list-bottom'>
                ...
                <div className='qna-list-search-box'>
                    <div className='qna-list-search-input-box'>
                        <input className='qna-list-search-input' placeholder='검색어를 입력하세요.' value={searchWord} onChange={onSearchWordChangeHandler} onKeyDown={onSearchKeydownHandler}  />
                    </div>
